import { pgTable, index, foreignKey, varchar, text, uniqueIndex, boolean } from "drizzle-orm/pg-core";
...
uniqueIndex("general_settings_locales_locale_parent_id_unique").on(table.locale, table.parentId),
    foreignKey({

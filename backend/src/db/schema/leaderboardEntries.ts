import { pgTable, index, foreignKey, varchar, integer, timestamp, uniqueIndex, check } from "drizzle-orm/pg-core";
...
export const leaderboardEntries = pgTable("leaderboard_entries", {
	...
	uniqueIndex("leaderboard_user_competition_season_idx").on(table.userId, table.competitionId, table.seasonYear),

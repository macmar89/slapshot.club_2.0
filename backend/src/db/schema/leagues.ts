import { pgTable, index, foreignKey, varchar, timestamp, integer, uniqueIndex, pgEnum } from "drizzle-orm/pg-core";
import { competitions } from "./competitions.js";
import { users } from "./users.js";
import { generateCuid, withUpdatesFields } from "../helpers.js";

export const enumLeaguesType = pgEnum("enum_leagues_type", ['private', 'vip', 'business', 'pub', 'partner'])

export const enumLeagueMemberStatus = pgEnum("enum_league_member_status", ['pending', 'active', 'rejected', 'banned'])
...
export const leagueMembers = pgTable("league_members", {
	...
	joinedAt: timestamp("joined_at", { precision: 3, withTimezone: true, mode: 'string' }).defaultNow(),
	...withUpdatesFields,
}, (table) => [

...
export const userReferrals = pgTable("user_referrals", {
	...
	uniqueIndex("user_referrals_referral_code_idx").using("btree", table.referralCode.asc().nullsLast().op("text_ops")),
	index("user_referrals_referred_by_idx").using("btree", table.referredById.asc().nullsLast().op("text_ops")),

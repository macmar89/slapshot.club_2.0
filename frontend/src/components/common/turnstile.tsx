...
import { Turnstile as MarsiTurnstile, type TurnstileProps, type TurnstileInstance } from '@marsidev/react-turnstile';
...
export const Turnstile = React.forwardRef<TurnstileInstance, CustomTurnstileProps>(
  ({ siteKey, ...props }, ref) => {

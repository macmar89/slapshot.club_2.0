...
export const VerifyView = ({ token, initialEmail }: VerifyViewProps) => {
  ...
  return (
    <div className="selection:bg-gold/30 selection:text-gold-light relative flex min-h-screen flex-col bg-black">
      ...
      <div className="relative flex flex-grow items-center justify-center overflow-hidden p-6">
        ...
        <IceGlassCard className="z-10 w-full max-w-md p-2 sm:p-4" backdropBlur="xl">
          <div className="relative z-10 flex w-full flex-col items-center rounded-2xl border border-white/5 bg-white/10 p-8 text-center shadow-inner sm:p-12">
